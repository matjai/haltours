<template>
  <v-container fluid class="pa-5 mt-10">
    <v-tabs dark background-color="deep-purple accent-4" centered fixed-tabs icons-and-text>
      <v-tab>
        <v-icon>mdi-airplane-takeoff</v-icon>Flights
      </v-tab>
      <v-tab>
        <v-icon>mdi-hotel</v-icon>Grounds
      </v-tab>
      <!-- <v-tab>
