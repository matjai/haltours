          ...
          <v-card-text>
            <v-row>
              ...
              <v-col cols="12" md="12" sm="12" class="pa-4">
                ...
                <v-btn color="pink" @click="save" dark right>Save
                </v-btn>
                <!-- <v-card-actions>
                  <v-spacer></v-spacer>
                        ...
                        <v-card-text>
                          <v-container>
                            <v-row>
                                ...
                                <v-col cols="12" sm="6" md="6">
                                    <v-text-field v-model="flightItem.number" label="Flight Number" dense placeholder="Flight Number" outlined></v-text-field>
                                </v-col>
                                <v-col cols="12" sm="6" md="6">
                                <v-menu
                                    ref="menu2"
                              ...
                              <v-col cols="12" sm="6" md="6">
                                <v-text-field label="Time" dense placeholder="Time" outlined></v-text-field>
                              </v-col>

                              <v-col cols="12" sm="6" md="6">
                                <v-text-field label="From" dense placeholder="From" outlined></v-text-field>
                              </v-col>

                              <v-col cols="12" sm="6" md="6">
                                <v-text-field label="To" dense placeholder="To" outlined></v-text-field>
                              </v-col>
                            </v-row>
                          </v-container>
                        </v-card-text>
